...
function calculateSalesTax(prouductPrice) {
  let tax = (20* prouductPrice) / 100 + prouductPrice;
return tax ;
}
...
function addTaxAndFormatCurrency(prouductPrice) {
return "£" + calculateSalesTax(prouductPrice).toFixed(2);
}
